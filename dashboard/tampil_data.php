  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-secondary alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Selamat Datang di Aplikasi Manajemen Barang Gudang.</span>
            ...
            <div class="row">
              <div class="col-5">
                <div class="icon-big2 text-center">
                  <i class="flaticon-box-2 text-white"></i>
                </div>
              </div>
        ...
        <div class="card card-stats card-success card-round">
          <div class="card-body ">
            <div class="row">
              <div class="col-5">
                <div class="icon-big2 text-center">
                  <i class="flaticon-inbox text-white"></i>
                </div>
              </div>
              <div class="col-7 col-stats">
                <div class="numbers">
        ...
        <div class="card card-stats card-warning card-round">
          <div class="card-body">
            <div class="row">
              <div class="col-5">
                <div class="icon-big2 text-center">
                  <i class="flaticon-archive text-white"></i>
                </div>
              </div>
              <div class="col-7 col-stats">
                <div class="numbers">
