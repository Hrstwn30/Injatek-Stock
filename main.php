...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Aplikasi Manajemen Barang Gudang dengan PHP 8 dan MySQLi" />
    <meta name="author" content="Markaz Virtual" />

    <!-- Title -->
    <title>Aplikasi Manajemen Barang Gudang</title>
        ...
        <div class="logo-header" data-background-color="blue">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              <span>
                <img src="assets/img/icon.png" alt="Logo" style="width: 30px; height: 30px;">
              </span>
              <span class="text-white">Markaz Gudang</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2023 - <a href="#" class="text-secondary">Markaz Virtual</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
